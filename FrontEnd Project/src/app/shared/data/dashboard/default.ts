import { graphDataTime } from "../../Models/GraphData";
...
let Nhour =JSON.parse(localStorage.getItem("GraphDataDay"))
let NhourCount =JSON.parse(localStorage.getItem("GraphDataDayCount"))

let callInList = JSON.parse(localStorage.getItem("callInList"));        
let callOutList = JSON.parse(localStorage.getItem("callOutList"));        
let callNameList = JSON.parse(localStorage.getItem("callNameList"));        
